...
export const Icons = {
  ...
  Brain: () => (
     <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M9.5 2A5 5 0 0 1 12 10a5 5 0 0 1 2.5-8 5 5 0 0 1 8 6 5 5 0 0 1-4 8.5 5 5 0 0 1-4 4.5 5 5 0 0 1-4-4.5 5 5 0 0 1-4-8.5 5 5 0 0 1 8-6Z"/></svg>
  ),
  Clipboard: () => (
